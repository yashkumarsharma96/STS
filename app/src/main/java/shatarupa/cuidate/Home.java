...
public class Home extends Activity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean cameraStatus=appSettings.getBoolean("cameraEnable",true);
        if(!cameraStatus)
        {
        ...
        helpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<numberOfEmergencyContacts;i++) {
                    Log.i("NumberOfContactsToSend","Number is"+numberOfEmergencyContacts);
                    sendLocation = appSettings.getBoolean("sendLocationStatus",true);
                    String user_message=appSettings.getString("user_text",getString(R.string.default_message));
                    if(sendLocation) {
                        textMessage = user_message+" I am currently at - http://maps.google.com/maps?q=" + latitude + "," + longitude;
                    }
                    else
                    {
